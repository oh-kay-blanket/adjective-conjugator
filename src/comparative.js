exports.comparativeCheck = function (value, syllables, comparative, comparativeMethod, comparativeExample, superlative, superlativeMethod, superlativeExample ) {
  ...
  if (syllables === '1') {
    ...
    // Ends in consonant
      ...
      if ((['a','e','i','o','u'].includes(value.slice(-2,-1))) && ((value.slice(-2,-1) !== value.slice(-3,-2)))) {
